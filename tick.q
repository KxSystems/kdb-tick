...
chk:{c:key flip v:value x;if[not `time`sym~2#c;:0b];16 11h~type each v`time`sym};
tick:{init[];if[not min chk each t;'`timesym];@[;`sym;`g#]each t;d::.z.D;if[l::count y;L::`$":",y,"/",x,10#".";l::ld d]};
